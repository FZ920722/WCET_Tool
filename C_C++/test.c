...
// clang test.c -w -S -emit-llvm -gline-tables-only -O0 -Xclang -disable-O0-optnone -fno-builtin -fno-jump-tables -fno-optimize-sibling-calls --target=arm -o ./test/test.ll
